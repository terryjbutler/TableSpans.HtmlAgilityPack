...
{
    [TestClass]
    public class RowSpanAdvanced1Test
        : TestBase
    {
        public RowSpanAdvanced1Test()
            : base("./files/rowspan-advanced-1.html")
        {
        }
        ...
        public void TestFirstDimensionBounds()
        {
            ...
            Assert.AreEqual(5, _array.GetUpperBound(0));
        }
        ...
        {
            Assert.AreEqual("(2,1) > (2,6)", _array[2, 1]);
        }

        [TestMethod]
        public void TestX2Y2()
        {
            Assert.AreEqual("(2,1) > (2,6)", _array[2, 2]);
        }

        [TestMethod]
        public void TestX2Y3()
        {
            Assert.AreEqual("(2,1) > (2,6)", _array[2, 3]);
        }

        [TestMethod]
        public void TestX2Y4()
        {
            Assert.AreEqual("(2,1) > (2,6)", _array[2, 4]);
        }

        [TestMethod]
        public void TestX2Y5()
        {
            Assert.AreEqual("(2,1) > (2,6)", _array[2, 5]);
        }

        [TestMethod]
        public void TestX2Y6()
        {
            Assert.AreEqual("(2,1) > (2,6)", _array[2, 6]);
        }
        ...
        {
            Assert.AreEqual("(3,1) > (3,3)", _array[3, 1]);
        }

        [TestMethod]
        public void TestX3Y2()
        {
            Assert.AreEqual("(3,1) > (3,3)", _array[3, 2]);
        }

        [TestMethod]
        public void TestX3Y3()
        {
            Assert.AreEqual("(3,1) > (3,3)", _array[3, 3]);
        }
        ...
        {
            Assert.AreEqual("(3,5) > (3,6)", _array[3, 5]);
        }

        [TestMethod]
        public void TestX3Y6()
        {
            Assert.AreEqual("(3,5) > (3,6)", _array[3, 6]);
        }
        ...
        {
            Assert.AreEqual("(4,1) > (4,2)", _array[4, 1]);
        }

        [TestMethod]
        public void TestX4Y2()
        {
            Assert.AreEqual("(4,1) > (4,2)", _array[4, 2]);
        }
        ...
        {
            Assert.AreEqual("(4,5) > (4,6)", _array[4, 5]);
        }
        [TestMethod]
        public void TestX4Y6()
        {
            Assert.AreEqual("(4,5) > (4,6)", _array[4, 6]);
        }
