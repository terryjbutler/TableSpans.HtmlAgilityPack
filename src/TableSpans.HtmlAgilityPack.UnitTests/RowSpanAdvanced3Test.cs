...
{
    [TestClass]
    public class RowSpanAdvanced3Test : TestBase
    {
        public RowSpanAdvanced3Test()
            : base("./files/rowspan-advanced-3.html")
        {
        }
        ...
        {
            Assert.AreEqual("(4,1) > (4,6)", _array[4, 1]);
        }

        [TestMethod]
        public void TestX4Y2()
        {
            Assert.AreEqual("(4,1) > (4,6)", _array[4, 2]);
        }

        [TestMethod]
        public void TestX4Y3()
        {
            Assert.AreEqual("(4,1) > (4,6)", _array[4, 3]);
        }

        [TestMethod]
        public void TestX4Y4()
        {
            Assert.AreEqual("(4,1) > (4,6)", _array[4, 4]);
        }

        [TestMethod]
        public void TestX4Y5()
        {
            Assert.AreEqual("(4,1) > (4,6)", _array[4, 5]);
        }
        [TestMethod]
        public void TestX4Y6()
        {
            Assert.AreEqual("(4,1) > (4,6)", _array[4, 6]);
        }
        ...
        {
            Assert.AreEqual("(5,5) > (5,6)", _array[5, 5]);
        }

        [TestMethod]
        public void TestX5Y6()
        {
            Assert.AreEqual("(5,5) > (5,6)", _array[5, 6]);
        }
